...
\input{cardinalidad/conjuntos}
\newpage
\input{cardinalidad/ordenes}
\newpage
\input{cardinalidad/eleccion}
\newpage
\input{cardinalidad/cardinalidad}

\chapter{Espacios Métricos}

\input{metricos/intromet}
\newpage
\input{metricos/topmet}
\newpage
\input{metricos/funcmet}
\newpage
\input{metricos/separables}
...
% sucesi´on de cauchy es acotada
% defi completitud
% defi completacion (categoricamente y normal)
% X comleto B(Z,X) completo y C(Y;X) completo
